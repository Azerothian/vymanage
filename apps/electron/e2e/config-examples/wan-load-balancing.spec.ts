...
test.describe('Config Example: WAN Load Balancing', () => {
  ...
  test.beforeEach(async () => {
    ...
    await openConfigInElectron(electronApp, page, WAN_LB_CONFIG, 'wan-lb.json');
  });
  ...
  test('WAN tab renders a table without crashing', async () => {
    await navigateToPanel(page, 'Load Balancing');
  ...
  test('Interfaces panel shows WAN interfaces', async () => {
