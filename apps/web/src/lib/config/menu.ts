...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    configPath: ['nat'],
    tabs: [
      { id: 'source', label: 'NAT44 Source', configPath: ['nat', 'source'] },
      { id: 'destination', label: 'NAT44 Destination', configPath: ['nat', 'destination'] },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'as-path-list', label: 'AS Path', configPath: ['policy', 'as-path-list'] },
      { id: 'community-list', label: 'Community', configPath: ['policy', 'community-list'] },
  ...
  },
  {
    ...
    tabs: [
      { id: 'containers', label: 'Containers', configPath: ['container', 'name'] },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'image-mgmt', label: 'Image Mgmt', configPath: [] },
    ],
  },
  {
    id: 'operations',
